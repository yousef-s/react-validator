...
export const Validator = ({ state, rules, children, onChange, onChangeKey }) => {
  // Iterate over rules
  const validationState = getValidationState(state, rules)
  // If onUpdate has been set, then let's call it if it's a function
  if (typeof onUpdate === 'function') {
    onChange(validationState, onChangeKey)
  }
  return children(validationState)
}
